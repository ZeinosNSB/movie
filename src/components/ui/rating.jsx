...
export const Rating = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className='flex items-center cursor-pointer' onMouseEnter={handleMouseEnter}>
      ...
      {showText && (
        <span className='text-xs text-muted-foreground font-semibold'>Current Rating: {`${currentRating}`}</span>
      )}
    </div>
  )
}
